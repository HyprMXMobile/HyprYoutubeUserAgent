...
- (void)viewDidLoad
{
    ...
    NSString *string = [NSString stringWithFormat:@"http://live.hyprmx.com/embedded_videos/catalog_frame?uid=%@&distributorid=7172365&offer=video-be0470a0c7f5315a5a8b488972a86be4&dob=%@", [[NSProcessInfo processInfo] globallyUniqueString], [formatter stringFromDate:date]];
